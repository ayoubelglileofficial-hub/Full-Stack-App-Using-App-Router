  ...
  return (
    <div className="h-[60vh] w-[90%] mx-auto flex  items-center justify-between gap-25 font-sans ">
      <div className="flex-1">
        <h1 className="text-7xl font-sans bg-gradient-to-b from-blue-500 to-black/80 dark:to-white bg-clip-text text-transparent font-bold">Drive your journey with confidence.</h1>
      ...
      <div className="flex-1">
      <Image  src="/pngegg.png" alt="carRental" width={600} height={800} className="floatY object-contain w-[100%]  h-[100%]" />
      </div>
    </div>
  );
}
